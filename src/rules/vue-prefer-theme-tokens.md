...
```vue
<!-- Reports hard-coded colors and spacing. -->
<div class="bg-[#123456] gap-[13px] [padding:13px]" />
...
It reports arbitrary colors and spacing, including equivalent arbitrary CSS properties.
...
Omit either option to use the stylesheet's named values.
